...
<div class="wp-block-group" style="min-height:100vh;display:grid;place-items:center;padding:48px;background-color:#c80000;">
  <!-- wp:group {"layout":{"type":"constrained"}} -->
  <div class="wp-block-group" style="text-align:center;max-width:800px">
    <!-- wp:site-logo {"width":120} /-->
	<img src="/wp-content/uploads/2026/07/logo.svg" />
